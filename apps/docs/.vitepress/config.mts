...
export default defineConfig({
  ...
  description: 'Documentation about Mini Apps as an open standard.',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: 'Copyright © 2025-present Vladislav Kibenko and Contributors',
    },

    editLink: {
      text: 'Edit this page on GitHub',
      pattern: 'https://github.com/open-mini-apps/monorepo/edit/master/apps/docs/:path',
    },
